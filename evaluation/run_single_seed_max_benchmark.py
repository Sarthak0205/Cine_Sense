...
from cinesense.recommenders.base import CineSenseSingleSeedMaxRecommender
...
RESULT_PATH = Path("evaluation/results/cinesense_single_seed_max_validation.json")
...
def main() -> None:
    ...
    model = CineSenseSingleSeedMaxRecommender().fit(catalog)
